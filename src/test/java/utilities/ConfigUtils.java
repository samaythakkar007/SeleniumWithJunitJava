...
public class ConfigUtils {
	...
	public String getUsername(String userType) throws Exception {
		try {
			return getConfigProperties().getPropInstance()
					.getProperty(getEnvironment() + "." + userType + "." + "username");
		} catch (Exception e) {
	...
	public String getPassword(String userType) throws Exception {
		try {
			return getConfigProperties().getPropInstance()
					.getProperty(getEnvironment() + "." + userType + "." + "password");
		} catch (Exception e) {
			throw new Exception("Exception occurred while fetching username from config file -->" + e);
		}
	}
	...
	public String getTestDataFilePath() throws Exception {
		try {
			return getConfigProperties().getPropInstance().getProperty(getEnvironment() + "." + "testdatafile");
		} catch (Exception e) {
			throw new Exception("Exception occurred while fetching data file path -->" + e);
		}
	}
